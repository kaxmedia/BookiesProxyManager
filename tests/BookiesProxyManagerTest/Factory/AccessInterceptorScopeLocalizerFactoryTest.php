 ...
 * @covers \BookiesProxyManager\Factory\AccessInterceptorScopeLocalizerFactory
 * @group Coverage
 */
final class AccessInterceptorScopeLocalizerFactoryTest extends TestCase
{
     ...
     * {@inheritDoc}
     *
     * @covers \BookiesProxyManager\Factory\AccessInterceptorScopeLocalizerFactory::__construct
     */
     ...
     *
     * @covers \BookiesProxyManager\Factory\AccessInterceptorScopeLocalizerFactory::__construct
     * @covers \BookiesProxyManager\Factory\AccessInterceptorScopeLocalizerFactory::createProxy
     * @covers \BookiesProxyManager\Factory\AccessInterceptorScopeLocalizerFactory::getGenerator
     */
        ...
        $autoloader
            ...
            ->willReturnCallback(static function () use ($proxyClassName): bool {
                eval(
                    ...
                    . ' extends \\BookiesProxyManagerTestAsset\\AccessInterceptorValueHolderMock {}'
                );
