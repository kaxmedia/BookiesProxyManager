...
/**
 * Tests for {@see \BookiesProxyManager\ProxyGenerator\LazyLoadingValueHolderGenerator} produced objects
 *
 * @group Functional
 * @coversNothing
 */
final class LazyLoadingValueHolderFunctionalTest extends TestCase
{
     ...
     */
    public function testMethodCalls(string $className, object $instance, string $method, array $params, mixed $expectedValue): void
    {
