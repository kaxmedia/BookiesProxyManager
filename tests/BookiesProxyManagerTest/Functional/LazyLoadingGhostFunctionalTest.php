...
use BookiesProxyManagerTestAsset\ClassWithMixedPropertiesAndAccessorMethods;
...
/**
 * Tests for {@see \BookiesProxyManager\ProxyGenerator\LazyLoadingGhostGenerator} produced objects
 *
 * @group Functional
 * @coversNothing
 */
    ...
    public function skipPropertiesFixture(): array
    {
        return [
            ...
            [
                ...
                'property9',
                [
                    'skippedProperties' => ["\0BookiesProxyManagerTestAsset\\ClassWithPrivateProperties\0property9"],
                ],
                'property9',
            ],
            [
                ...
                'property0',
                [
                    'skippedProperties' => ["\0BookiesProxyManagerTestAsset\\ClassWithCollidingPrivateInheritedProperties\0property0"],
                ],
                'childClassProperty0',
            ],
            [
                ...
                'property0',
                [
                    'skippedProperties' => ["\0BookiesProxyManagerTestAsset\\ClassWithPrivateProperties\0property0"],
                ],
                'property0',
            ],
        ];
