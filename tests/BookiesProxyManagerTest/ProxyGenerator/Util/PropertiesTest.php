...
/**
 * Tests for {@see \BookiesProxyManager\ProxyGenerator\Util\Properties}
 *
 * @covers \BookiesProxyManager\ProxyGenerator\Util\Properties
 * @group  Coverage
 */
final class PropertiesTest extends TestCase
{
    ...
    {
        $propertyName = "\0BookiesProxyManagerTestAsset\\ClassWithCollidingPrivateInheritedProperties\0property0";
    ...
    public function propertiesToSkipFixture(): array
    {
        return [
            ...
            ["\0BookiesProxyManagerTestAsset\\ClassWithMixedProperties\0privateProperty0"],
        ];
    }
